...
import '../App.css';
import profileImage from '../img1.png';
  ...
  return (
    <nav className="navbar">
      <div className="navbar-logo">
        ...
        <span className="logo-text">WebPortal</span>
      </div>
      <ul className="navbar-links">
        ...
        <li>
          <Link to="/posts" className={location.pathname === '/posts' ? 'active' : ''}>Post</Link>
        </li>
        ...
        {userData ? (
          ...
          <li>
          <i className="fas fa-sign-out-alt logo-icon" style={{cursor:'pointer'}} onClick={logout}>Salir</i>
